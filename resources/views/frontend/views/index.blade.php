...
@section('title', 'Ahmad Networking')
@section('content')
        ...
        <div class="container">
            <div class="row d-flex">
                <div class="col-lg-6 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">Ahmad Networking Providing network services</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">We are a team of talented engineers that provide
                        extensive
                        networking services using the latest technologies</h2>
                ...
                <div class="col-lg-6 anas hero-img" data-aos="zoom-out" data-aos-delay="200">
                    <img src={{ asset('assets/img/hero-img.png') }} class="img-fluid mx-3" alt="">
                </div>
            </div>
        </div>
    ...
    <main id="main">
        ...
        <section id="about" class="about">
            ...
            <div class="container" data-aos="fade-up">
                <div class="row gx-0">
                    <div class="col-lg-5 d-flex justify-content-center align-items-center" data-aos="zoom-out"
                        data-aos-delay="200">
                        <img src={{ asset('assets/img/about.jpg') }} class="img-fluid rounded-circle" alt="">
                    </div>

                    <div class="col-lg-7 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                        <div class="content">
                            <h3>who am I</h3>
                            <h2>The engineer: Ahmad Arbasha </h2>
                            <h2>Specialist and professional in network and electronic transactions</h2>
                ...
                <div class="row">
                    @foreach ($Articles as $Article)
                        <div class="col-lg-4">
                            <div class="post-box">
                                <div class="post-img">
                                    <img src="{{ asset('images/articles/' . $Article->photo) }}" class="img-fluid"
                                        alt="">
                                </div>
                                <span class="post-date">{{ $Article->created_at }}</span>
                                <h3 class="post-title">{{ $Article->title }}</h3>
                                <a href="{{ route('oneArticle', $Article->id) }}"
            ...
            <div class="container" data-aos="fade-up">
                <div class="row gy-4 ">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <a href="https://www.facebook.com/ahmadarbasha11" target="_blank">
                            <div class="count-box">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <a href="https://www.YouTube.com" target="_blank">
                            <div class="count-box">
                                <i class="bi bi-youtube" style="color: #ce0101;"></i>
                                <div>
                                    <p>YouTube</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <a href="https://www.linkedin.com/in/ahmadarbasha/" target="_blank">
                            <div class="count-box">
                                <i class="bi bi-linkedin" style="color: #1531be;"></i>
                                <div>
                                    <p>Linkedin</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <a href="https://www.instagram.com/ahmad.arbasha1/" target="_blank">
                            <div class="count-box">
                                <i class="bi bi-instagram" style="color: #e70161;"></i>
                                <div>
                                    <p>Instagram</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <a href="https://t.me/Ahmadarbasha" target="_blank">
                            <div class="count-box">
                                <i class="bi bi-telegram" style="color: #036bc6;"></i>
                                <div>
                                    <p>Telegram</p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <a href="" target="_blank">
                            <div class="count-box">
                                <i class="bi bi-whatsapp" style="color: #1fae02;"></i>
                                <div>
                                    <p>Whatsapp</p>
                                </div>
                            </div>
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <h3>Call Us</h3>
                                    <p>+963-0994155635<br>+963-0994155635</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <h3>Email Us</h3>
                                    <p>ahmad.arbasha1@gmail.com<br>ahmad.arbasha1@gmail.com</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box">
