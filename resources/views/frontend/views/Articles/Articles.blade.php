                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry">
                            ...
                            <div class="entry-content">
                                ...
                                <div class="read-more">
                                    {{-- {{ $Article->id }} --}}
                                    <a href="{{ route('oneArticle' , $Article->id) }}">Read More</a>
                                </div>
                            </div>
                        ...
                        <div class="blog-pagination">
                            <ul class="d-flex justify-content-center" style="width: 300px:height:100px">
                                {{-- {!! $Articles->links() !!} --}}
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar-item recent-posts">
                                ...
                                <div class="post-item clearfix">
                                    <img src={{ asset('images/articles/' . $Article->photo) }} alt="">
                                    <h4><a href="blog-single.html">{{ $Article->title }}</a></h4>
