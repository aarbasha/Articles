                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card mt-2 p-4">
                                <form action="{{ route('manger.update', $users->id) }}" method="post">
                                    @csrf
                                    <div class="row p-2">
                                        ...
                                        <div class="col-lg-4 form-group">
                                            ...
                                            <input type="text"  class="form-control" name="location"  value="{{ $users->location }}">
                                        </div>
                                        ...
                                        <div class="col-lg-4 form-group">
                                            ...
                                            <input type="number"  class="form-control" name="phone1" value="{{  $users->phone1 }}">
                                        </div>
