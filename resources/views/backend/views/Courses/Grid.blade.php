                                ...
                                <div class="card m-1" style="width: 18rem;">
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-center ">
                                        ...
                                        <div>
                                            ...
                                            <p>number vedios : {{ $Course->number_videos }}</p>
                                        </div>
                                        <div class="card-footer p-0 m-0 d-flex justify-content-between">
                                            <a href="{{ $Course->url }}" class="btn btn-primary m-1"
                                                target="_blank">Seen Tha Course</a>

                                            <div class="dropdown show">
                                                <a class="btn btn-success  mt-1 dropdown-toggle m-1" href="#"
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <a href="{{ route('Courses.delete', $Course->id) }}" class="btn dropdown-item d-flex justify-content-between my-1">
                                                        Delete <i class="fas fa-trash m-1"></i>
                                                    </a>

                                                    <a href="{{ route('Courses.edit', $Course->id) }}" class="btn dropdown-item d-flex justify-content-between my-1">
                                                       Edit <i class="fas fa-edit m-1"></i>
                                                    </a>

                                                    <a href="{{ route('Courses.show', $Course->id) }}" class="btn dropdown-item d-flex justify-content-between my-1">
                                                        Info 'Admin' <i class="fa fa-arrow-right" aria-hidden="true"></i>
                                                    </a>

                                                    <a href="" class="btn dropdown-item d-flex justify-content-between my-1">
