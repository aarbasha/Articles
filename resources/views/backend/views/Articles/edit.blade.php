                                ...
                                <form action="{{ route('Articles.update', $articles->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <select name="sections_id" class="form-control" style="width: 100%;">
                                                <option value="{{ $articles->sections_id }}" selected>Chois Section ..</option>
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <input type="text" disabled name="sections_id" class="form-control" id="title" value="{{ $articles->section->title }}">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="description" class="form-control" id="description" value="{{ $articles->description }}">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="photo">Uploud Photo</label>
                                            <input type="file" name="photo" class="form-control" id="photo" value="{{ $articles->photo }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card">
                                            ...
                                            <!-- /.card-header -->
                                            <div class="card-body">
                                                <textarea class="forn-control" id="summernote" name="article" rows="10">{{ $articles->article }}</textarea>
                                            </div>
                                        </div>
