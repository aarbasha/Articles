    ...
    <div class="content-wrapper mt-5 p-2">
        ...
        <div class="content-header">
            <div class="container-fluid mt-5 ">
                <div class="row mb-2 ">
                    <div class="col-sm-6">
                        <h1 class="m-0">Hallo Master {{ Auth::user()->name }}</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src={{ asset('admin/dist/img/user1-128x128.jpg') }} alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src={{ asset('admin/dist/img/user7-128x128.jpg') }} alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src={{ asset('admin/dist/img/user3-128x128.jpg') }} alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src={{ asset('admin/dist/img/user5-128x128.jpg') }} alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src={{ asset('admin/dist/img/user6-128x128.jpg') }} alt="User Avatar">
